...
slug: feux-pales/experiment-a/alt-a2-a3-a4
caseStudy: feux-pales
experiment: a
alternative: [a2, a3, a4]
type: modelling
ontologies: [lrmoo, frbroo]
ruptures: [R1, R3, R4]
ruptures-resolved: [R1-partial, R3-partial, R4-partial]
ruptures-introduced: [unified-intent, stable-referent, non-standard-extension]
date: 2026-07-29
lang: en
status: published
